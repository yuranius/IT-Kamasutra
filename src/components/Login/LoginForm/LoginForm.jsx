			...
			{({ isSubmitting }) => (
				<Form>
					<div className={scss["card__form"]}>
						<Field type="email" name={"email"} className={scss["card__input"]} placeholder="💥 Ваш электронный адрес" />
						<i className="/"></i>
					...
					<div className="card__form">
						<Field type="password" name={"password"} className={scss["card__input"]} placeholder="💫 Пароль" />
						<i className="/"></i>
					</div>

					<div className={scss["card__check"]}>
						<Field type="checkbox" name={"checkbox"} className={scss["card__check-input"]} />
