      ...
      <div className={scss["card"]}>
         <div className={scss["card__block"]}>
            <div className={scss["card__body"]}>
               ...
               {props.followed ? (
                  <button disabled={props.users.followingInProgress.some(id => id === props.id)} onClick={follow} className={props.users.followingInProgress.some(id => id === props.id) ? scss["card__button-disabled"] : scss["card__button"]}>
                     UnFollow
                  </button>
               ) : (
                  <button disabled={props.users.followingInProgress.some(id => id === props.id)} onClick={unfollow} className={props.users.followingInProgress.some(id => id === props.id) ? scss["card__button-disabled"] : scss["card__button"]}>
                     Follow
                  </button>
               )}
            </div>
